...
const index = require('./index-770de9ac.js');
...
class WasmSDKWorker {
    ...
    getProductIntegrationInfo() {
        return new Promise((resolve, reject) => {
            const msg = new GetProductIntegrationInfo();
            const handler = defaultResultEventHandler((msg) => {
                resolve(msg.result);
            }, reject);
...
(function (DocumentType) {
    ...
    DocumentType[DocumentType["COUNT"] = 48] = "COUNT";
...
let MbApiProcessStatus = class {
  ...
  render() {
    return (index.h(index.Host, { className: classNames({ visible: this.visible }) }, this.state === 'LOADING' &&
...
let MbButton = class {
  ...
  render() {
    return (index.h(index.Host, { className: classNames({ visible: this.visible, disabled: this.disabled, icon: this.icon, selected: this.selected }), onClick: (ev) => this.handleClick(ev) }, index.h("a", { onMouseOver: this.handleMouseOver.bind(this), onMouseOut: this.handleMouseOut.bind(this), href: "javascript:void(0)" }, this.imageSrcDefault && this.imageAlt === 'action-alt-camera' &&
...
let MbButtonClassic = class {
  ...
  render() {
    return (index.h(index.Host, { className: classNames({ disabled: this.disabled }), onClick: (ev) => this.handleClick(ev) }, index.h("a", { href: "javascript:void(0)" }, index.h("slot", null))));
  }
  get hostEl() { return index.getElement(this); }
};
...
let MbFeedback = class {
  ...
  render() {
    return (index.h(index.Host, { className: classNames({ visible: this.visible }) }, index.h("p", { class: this.paragraphClassName }, this.paragraphValue)));
  }
  get hostEl() { return index.getElement(this); }
};
...
let MbOverlay = class {
  ...
  render() {
    return (index.h(index.Host, { className: `${classNames({ visible: this.visible, 'non-fullscreen': !this.fullscreen })} ${this.getHostClassNames()}` }, index.h("slot", null)));
  }
  get hostEl() { return index.getElement(this); }
};
...
let MbScreen = class {
  ...
  render() {
    return (index.h(index.Host, { className: classNames({ visible: this.visible }) }, index.h("slot", null)));
  }
  get hostEl() { return index.getElement(this); }
};
...
let MbSpinner = class {
  ...
  render() {
    return (index.h(index.Host, { className: this.size }, index.h("img", { src: this.icon })));
  }
  get hostEl() { return index.getElement(this); }
};
