...
export enum FaceTecAuditTrailType {
    Disabled = 0,
    FullResolution = 1
}
export enum FaceTecRetryScreen {
...
export interface FaceTecFaceScanResultCallback {
...
export interface FaceTecFaceScanProcessor {
...
export enum FaceTecIDScanStatus {
    /**
...
export interface FaceTecIDScanResultCallback {
    cancel: () => void;
    uploadProgress: (uploadedPercent: number) => void;
    uploadMessageOverride: (uploadMessageOverride: string) => void;
    proceedToNextStep: (scanResultBlob: string, idScanNextStep?: FaceTecIDScanNextStep) => void;
...
export interface FaceTecIDScanProcessor {
    onFaceTecSDKCompletelyDone: () => void;
    processSessionResultWhileFaceTecSDKWaits: (sessionResult: FaceTecSessionResult, faceScanResultCallback: FaceTecFaceScanResultCallback) => void;
    processIDScanResultWhileFaceTecSDKWaits: (idScanResult: FaceTecIDScanResult, idCheckResultCallback: FaceTecIDScanResultCallback) => void;
}
/**
 ...
 */
export enum FaceTecIDScanNextStep {
    /**
 ...
 */
export enum FaceTecAuditTrailImagesToReturn {
    ONE = '1',
    UP_TO_SIX = '6'
}
